...
def testNewAbundances(fileNames,moleculeAbundances):
    ...
    for index,file in enumerate(fileNames):
        ...
        workingConfigFilePath=r"C:\Users\Tristan\Downloads\HyPCAR3\workingDirectory"+f"working-{index}.txt"
...
if __name__ == '__main__':
    ...
    for atmosphereType in ["A","B","C"]:
        ...
        curFolderPath=r"C:\Users\Tristan\Downloads\HyPCAR3\data"+f"\\{atmosphereType}"

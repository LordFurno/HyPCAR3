...
def detectMolecules(data):
    ...
    detect.load_state_dict(torch.load("/home/bobb/projects/def-pjmann/bobb/flexibleDetectionModel.pt",weights_only=True))
    with torch.no_grad():
        outputs=detect(data)
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load("/home/bobb/projects/def-pjmann/bobb/finalBaseAbundance.pt",weights_only=True))
    ...
    for epoch in range(numEpochs):
        ...
        with open("hypcarAbundance3.txt",'a') as f:
    ...
    torch.save(model.state_dict(), "hypcarAbundance3.pt")
    model.eval()
